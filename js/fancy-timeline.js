...
(function($) {  
    $.fn.fancyTimeline = function(params) {
        ...
        for (i=0; i<dataObjs.length; i++){
            ...
            if(dateObj.type == "image0"){
                dateStr += '<div id="date-'+ i +'" class="timeline-item item-image" >';
                dateStr +=  '<div class="timeline-item-content" >';
                dateStr +=      '<span class="title">' + dateObj.title + '</span>';
                dateStr +=      '<p></p><a href="http://www.behance.net/gallery/The-Space-Invader/3670425" target="blank"><img src="http://behance.vo.llnwd.net/profiles9/1082205/projects/3670425/5357af3f84e3795ac371267cbba27afd.jpg"></a>';
                dateStr +=      '<p>' + dateObj.content + '</p>';
                dateStr +=  '</div>';
                dateStr += '</div>';
            }
			if(dateObj.type == "image1"){
                dateStr += '<div id="date-'+ i +'" class="timeline-item item-image" >';
                dateStr +=  '<div class="timeline-item-content" >';
                dateStr +=      '<span class="title">' + dateObj.title + '</span>';
                dateStr +=      '<p></p><a href="http://ba-work.clemens-anzmann.de" target="blank"><img src="http://behance.vo.llnwd.net/profiles9/1082205/projects/3666085/7695fa4fbbe3455122d30d53f2e975b1.jpg"></a>';
                dateStr +=      '<p>' + dateObj.content + '</p>';
                dateStr +=  '</div>';
                dateStr += '</div>';
            }
			if(dateObj.type == "image2"){
                dateStr += '<div id="date-'+ i +'" class="timeline-item item-image" >';
                dateStr +=  '<div class="timeline-item-content" >';
                dateStr +=      '<span class="title">' + dateObj.title + '</span>';
                dateStr +=      '<p></p><a href="http://starsound.clemens-anzmann.de" target="blank"><img src="http://behance.vo.llnwd.net/profiles9/1082205/projects/3672741/c4cfe58c5446ff0b2ef0bca86ae0f3c1.png"></a>';
                dateStr +=      '<p>' + dateObj.content + '</p>';
                dateStr +=  '</div>';
                dateStr += '</div>';
            }
			if(dateObj.type == "image3"){
                dateStr += '<div id="date-'+ i +'" class="timeline-item item-image" >';
                dateStr +=  '<div class="timeline-item-content" >';
                dateStr +=      '<span class="title">' + dateObj.title + '</span>';
                dateStr +=      '<p></p> <p>&nbsp;</p><a href="http://www.behance.net/clemensanzmann" target="blank"><img src="img/behance.png"></a>';
                dateStr +=      '<p>' + dateObj.content + '</p>';
                dateStr +=  '</div>';
                dateStr += '</div>';
            }
			if(dateObj.type == "image4"){
                dateStr += '<div id="date-'+ i +'" class="timeline-item item-image" >';
                dateStr +=  '<div class="timeline-item-content" >';
                dateStr +=      '<span class="title">' + dateObj.title + '</span>';
                dateStr +=      '<p></p> <p>&nbsp;</p><a href="http://soundcloud.com/clemensanzmann" target="blank"><img src="img/clemens anzmann soundcloud.png">';
                dateStr +=      '<p>' + dateObj.content + '</p>';
                dateStr +=  '</div>';
                dateStr += '</div>';
            }
			if(dateObj.type == "image5"){
                dateStr += '<div id="date-'+ i +'" class="timeline-item item-image" >';
                dateStr +=  '<div class="timeline-item-content" >';
                dateStr +=      '<span class="title">' + dateObj.title + '</span>';
                dateStr +=      '<p></p><a href="http://www.mediale.org/2010/index.php/2k10/05/05/was-blinkt-da-uber-der-erde/" target="blank"><img src="http://www.mediale.org/2010/2010/wp-content/uploads/2010/05/DSC00197.jpg"></a>';
                dateStr +=      '<p>' + dateObj.content + '</p>';
                dateStr +=  '</div>';
                dateStr += '</div>';
            }
